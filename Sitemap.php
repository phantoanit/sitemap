...
class Sitemap
{
     ...
     * @throws \InvalidArgumentException
     */
    public function addItem($location, $lastModified = null, $changeFrequency = null, $priority = null, $alternate = null)
    {
        ...
        if (is_array($location)) {
            ...
            $this->addSingleLanguageItem($location, $lastModified, $changeFrequency, $priority, $alternate);
        }
     ...
     * @see addItem
     */
    private function addSingleLanguageItem($location, $lastModified, $changeFrequency, $priority, $alternate)
    {
